...
class Class4WebhooksApi
{
     ...
     *
     * @param  \ChatapiApis\Model\WebhookUrl $webhook_url webhook_url (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChatapiApis\Model\SetWebhookStatus
     */
     ...
     * Sets the URL for receiving webhook
     *
     * @param  \ChatapiApis\Model\WebhookUrl $webhook_url (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\SetWebhookStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function setWebhookWithHttpInfo($webhook_url)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ChatapiApis\Model\SetWebhookStatus' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ChatapiApis\Model\SetWebhookStatus', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ChatapiApis\Model\SetWebhookStatus';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ChatapiApis\Model\SetWebhookStatus',
