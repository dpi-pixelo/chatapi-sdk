...
class Class2MessagesApi
{
     ...
     *
     * @param  \ChatapiApis\Model\ForwardMessageRequest $forward_message_request forward_message_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChatapiApis\Model\SendMessageStatus
     */
     ...
     * Forwarding messages to a new or existing chat.
     *
     * @param  \ChatapiApis\Model\ForwardMessageRequest $forward_message_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function forwardMessageWithHttpInfo($forward_message_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ChatapiApis\Model\SendMessageStatus' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ChatapiApis\Model\SendMessageStatus', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ChatapiApis\Model\SendMessageStatus';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ChatapiApis\Model\SendMessageStatus',
     ...
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChatapiApis\Model\Messages
     */
     ...
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\Messages, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMessagesWithHttpInfo($last_message_number = null, $last = false, $chat_id = null, $limit = null, $min_time = null, $max_time = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ChatapiApis\Model\Messages' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ChatapiApis\Model\Messages', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ChatapiApis\Model\Messages';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     *
     * @param  \ChatapiApis\Model\SendContactRequest $send_contact_request send_contact_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChatapiApis\Model\SendMessageStatus
     ...
     * Sending a contact or contact list to a new or existing chat.
     *
     * @param  \ChatapiApis\Model\SendContactRequest $send_contact_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \ChatapiApis\Model\SendFileRequest $send_file_request send_file_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChatapiApis\Model\SendMessageStatus
     ...
     * Send a file to a new or existing chat.
     *
     * @param  \ChatapiApis\Model\SendFileRequest $send_file_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \ChatapiApis\Model\SendLinkRequest $send_link_request send_link_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChatapiApis\Model\SendMessageStatus
     ...
     * Send text with link and link&#39;s preview to a new or existing chat.
     *
     * @param  \ChatapiApis\Model\SendLinkRequest $send_link_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \ChatapiApis\Model\SendLocationRequest $send_location_request send_location_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChatapiApis\Model\SendMessageStatus
     ...
     * Sending a location to a new or existing chat.
     *
     * @param  \ChatapiApis\Model\SendLocationRequest $send_location_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \ChatapiApis\Model\SendMessageRequest $send_message_request send_message_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChatapiApis\Model\SendMessageStatus
     ...
     * Send a message to a new or existing chat.
     *
     * @param  \ChatapiApis\Model\SendMessageRequest $send_message_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \ChatapiApis\Model\SendPTTRequest $send_ptt_request send_ptt_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChatapiApis\Model\SendMessageStatus
     ...
     * Send a ptt-audio to a new or existing chat.
     *
     * @param  \ChatapiApis\Model\SendPTTRequest $send_ptt_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \ChatapiApis\Model\SendVCardRequest $send_v_card_request send_v_card_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChatapiApis\Model\SendMessageStatus
     ...
     * Sending a vcard to a new or existing chat.
     *
     * @param  \ChatapiApis\Model\SendVCardRequest $send_v_card_request (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
