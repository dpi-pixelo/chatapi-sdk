...
class Class6BanApi
{
     ...
     * Test ban settings
     *
     * @param  \ChatapiApis\Model\BanTestAction $ban_test_action ban_test_action (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChatapiApis\Model\BanTestStatus
     */
     ...
     * Test ban settings
     *
     * @param  \ChatapiApis\Model\BanTestAction $ban_test_action (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\BanTestStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function banTestWithHttpInfo($ban_test_action)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ChatapiApis\Model\BanTestStatus' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ChatapiApis\Model\BanTestStatus', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ChatapiApis\Model\BanTestStatus';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ChatapiApis\Model\BanTestStatus',
     ...
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChatapiApis\Model\BanSettings
     */
     ...
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\BanSettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBanSettingsWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ChatapiApis\Model\BanSettings' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ChatapiApis\Model\BanSettings', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ChatapiApis\Model\BanSettings';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * Set settings
     *
     * @param  \ChatapiApis\Model\BanSettings $ban_settings ban_settings (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChatapiApis\Model\BanSettings
     ...
     * Set settings
     *
     * @param  \ChatapiApis\Model\BanSettings $ban_settings (required)
     *
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\BanSettings, HTTP status code, HTTP response headers (array of strings)
