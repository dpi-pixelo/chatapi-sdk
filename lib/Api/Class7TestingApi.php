...
class Class7TestingApi
{
     ...
     * @return \ChatapiApis\Model\Statuses
     */
     ...
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\Statuses, HTTP status code, HTTP response headers (array of strings)
     */
    public function instanceStatusesWithHttpInfo($min_time = null, $max_time = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ChatapiApis\Model\Statuses' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ChatapiApis\Model\Statuses', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ChatapiApis\Model\Statuses';
     ...
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChatapiApis\Model\WebhookStatus
     */
     ...
     * @throws \ChatapiApis\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChatapiApis\Model\WebhookStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhookStatusesWithHttpInfo($msg_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ChatapiApis\Model\WebhookStatus' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ChatapiApis\Model\WebhookStatus', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ChatapiApis\Model\WebhookStatus';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ChatapiApis\Model\WebhookStatus',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
